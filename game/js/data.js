...
var appProfilesPerVisit=4;
var casualEncounterChance=15;
var messageChance=50;
var inviteTexts=[];
...
function loadGameData(){
  return fetch('data/data.json')
    ...
    .then(function(data){
      ...
      appProfilesPerVisit=(data.appProfilesPerVisit!==undefined)?data.appProfilesPerVisit:4;
      casualEncounterChance=(data.casualEncounterChance!==undefined)?data.casualEncounterChance:15;
      messageChance=(data.messageChance!==undefined)?data.messageChance:50;
      inviteTexts=data.inviteTexts||[];
